...
foreach($src_arr['nodes'] as $node_arr) {                                                    // run through nodes
  ...
  foreach($filters_arr as $filter_str) {                                                     // run through filters
    if($node->name &&                                                                        // if node has a name
       strtoupper(substr($node->name,0,strlen($filter_str))) == strtoupper($filter_str)) {   // beginning with filterstring
